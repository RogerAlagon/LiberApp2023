    ...
    <b-card>
        <b-row>
            <b-col md="9" xl="9" class="text-left">
                <h4> HISTORIAL DE ABASTECIMIENTOS</h4>
            </b-col>
...
data() {
    return {
        ...
        estados: [
            ...
            { value: 'REGISTRADO', text: 'DEPOSITADO' },
...
methods: {
    ...
    Listar()
    {
        ...
        this.$http.get('/LiberAPP/Abastecimientod/Historial/'+this.estado+'/'+this.yfinicio+'/'+this.yffin)
        .then(res => {
