<template>
    <b-row>
        <b-col>
            <renovacion-documento v-if="entidades[0] !== undefined && areas[0] !== undefined"
            ...
            </renovacion-documento>
        </b-col>
    </b-row>
</template>
<script>
import { BRow, BCol } from 'bootstrap-vue'
import  Asignacion from '../../Gestion/Transaccion/Asignacion.vue'

export default { 
    components: { 
        BRow, 
        BCol,
        'renovacion-documento': Asignacion
    }, 
    data() { 
        return { 
            entidad: 0, 
