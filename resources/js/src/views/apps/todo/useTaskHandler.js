...
export default function useTaskHandler(props, emit) {
  ...
  const assigneeOptions = [
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Jane Foster' },
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Donna Frank' },
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Gabrielle Robertson' },
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Lori Spears' },
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Sandy Vega' },
    { avatar: require('@/assets/images/avatars/13-small.png'), fullName: 'Cheryl May' },
  ]
