...
export default {
  ...
  setup(_, { emit }) {
    ...
    const emailToOptions = [
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Jane Foster' },
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Donna Frank' },
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Gabrielle Robertson' },
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Lori Spears' },
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Sandy Vega' },
      { avatar: require('@/assets/images/avatars/13-small.png'), name: 'Cheryl May' },
    ]
