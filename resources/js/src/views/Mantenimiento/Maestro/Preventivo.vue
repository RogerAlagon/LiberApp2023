<template>
    <b-row>
        <b-col>
            <preventivo-mantto  v-if="entidades[0] !== undefined && areas[0] !== undefined"
...
import Preventivo from '../../Gestion/Maestro/Implemento.vue'
