...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    Listar: function Listar() {
      ...
      this.$http.get('/LiberAPP/Reportef/Listar/' + this.fechaInicio + '/' + this.fechaFin).then(function (res) {
        _this.reportes = res.data;
    ...
    Guardar: function Guardar() {
      ...
      this.$http.post('/LiberAPP/Vehiculo/Guardar', {
        ...
        _this2.Toast(true, 'success', 'Agregar Vehiculo', 'Guardado Correctamente');
        ...
        _this2.Toast(true, 'danger', 'Agregar Vehiculo', 'Error al guardar el registro: ' + error);
    ...
    Actualizar: function Actualizar() {
      ...
      this.$http.post('/LiberAPP/Vehiculo/Actualizar', {
        ...
        _this3.Toast(true, 'primary', 'Actualizar Vehiculo', 'Actualizado Correctamente');
        ...
        _this3.Toast(true, 'danger', 'Actualizar Vehiculo', 'Error al actualizar el registro: ' + error);
    ...
    Verificar: function Verificar(prm_reportef) {
      var _this5 = this;

      //this.showLoading = true;
      //var jsonVehiculo = JSON.stringify(this.vehiculo);
      this.$http.get('/LiberAPP/Reportef/Verificar/' + prm_reportef, {//vehiculo: jsonVehiculo,
      }).then(function (res) {
        //this.Toast(true,'success','Agregar Vehiculo','Guardado Correctamente');
        //this.showModal = false;
        //this.showLoading = false;
        _this5.reportef = res.data; //this.Vehiculos();
      })["catch"](function (error) {
        _this5.Toast(true, 'danger', 'Agregar Vehiculo', 'Error al guardar el registro: ' + error);
    ...
    Validar: function Validar() {
      ...
      this.$http.post('/LiberAPP/Reportef/Validar', {
        ...
        _this6.Toast(true, 'success', 'Reporte de Fallas', 'Guardado Correctamente');

        _this6.showModal = false;
        _this6.showLoading = false; //this.reportef = res.data;

        _this6.Reportes();
      })["catch"](function (error) {
        _this6.Toast(true, 'danger', 'Agregar Vehiculo', 'Error al guardar el registro: ' + error);

        _this6.showLoading = false;
      });
    },
    Reportes: function Reportes() {
      var _this7 = this;

      this.$http.get('/LiberAPP/Reportef').then(function (res) {
        _this7.reportes = res.data;
      })["catch"](function (error) {
        _this7.Toast(true, 'danger', 'Vehiculo', 'Error al cargar los registros: ' + error);
  ...
  created: function created() {
    ...
    this.$http.get('/LiberAPP/Reportef/Listar/' + this.fechaInicio + '/' + this.fechaFin).then(function (res) {
      _this8.reportes = res.data;
    })["catch"](function (error) {
      _this8.Toast(true, 'danger', 'Fallas', 'Error al cargar los registros: ' + error);
    });
...
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Reportef.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=style&index=0&lang=scss&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206& ***!
  \********************************************************************************************************************************************************************************************************************************/
            ...
            scopedSlots: _vm._u([
              {
                ...
                fn: function(props) {
                  return [
                    props.column.field === "estadoRep"
                      ? _c(
                          "span",
                          [
                            props.row.estadoRep == "SOLICITADO"
                              ? _c(
                                  "b-badge",
                      ...
                      ? _c("span", [
                          ...
                          _c(
                            "a",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.Verificar(props.row.idReportef)
                                }
                              }
                            },
                            [
            ...
            [
              _c("b-col", { attrs: { md: "12", xl: "12" } }, [
                _c(
                  ...
                  [
                    _vm._l(_vm.reportef.cuerpo, function(uapartado, indice) {
                      return uapartado.com.length > 0
                        ? [
                            _c("tr", [
                              _c("th", { attrs: { colspan: "5" } }, [
                                _vm._v(_vm._s(uapartado.det))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("tr", [
                            ...
                            _vm._v(" "),
                            _vm._l(uapartado.com, function(
                              ucomponente,
                              indice
                            ) {
                              return _c("tr", [
                                _c("td", [_vm._v(_vm._s(ucomponente.det))]),
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(ucomponente.val))]),
                                _vm._v(" "),
                                ucomponente.tip == "VEHICULO" ||
                                ucomponente.tip == "AMBOS"
                                  ? _c("td", [_vm._v("X")])
                                  : _c("td"),
                                _vm._v(" "),
                                ucomponente.tip == "ACOPLE" ||
                                ucomponente.tip == "AMBOS"
                                  ? _c("td", [_vm._v("X")])
                                  : _c("td")
                              ])
...
/***/ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue":
/*!*******************************************************************!*\
  !*** ./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue ***!
  \*******************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Reportef.vue?vue&type=template&id=03057206& */ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206&");
/* harmony import */ var _Reportef_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Reportef.vue?vue&type=script&lang=js& */ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Reportef.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=style&index=0&lang=scss&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Reportef_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/Mantenimiento/Reporte/Reportef.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js&":
/*!********************************************************************************************!*\
  !*** ./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Reportef.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=style&index=0&lang=scss&":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader!../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Reportef.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206&":
/*!**************************************************************************************************!*\
  !*** ./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206& ***!
  \**************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Reportef.vue?vue&type=template&id=03057206& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Mantenimiento/Reporte/Reportef.vue?vue&type=template&id=03057206&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Reportef_vue_vue_type_template_id_03057206___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
