...
/* harmony import */ var _vue_composition_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @vue/composition-api */ "./node_modules/@vue/composition-api/dist/vue-composition-api.esm.js");
...
/* harmony import */ var _core_utils_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @core/utils/utils */ "./resources/js/src/@core/utils/utils.js");
/* harmony import */ var _core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @core/comp-functions/ui/app */ "./resources/js/src/@core/comp-functions/ui/app.js");
/* harmony import */ var _TodoLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./TodoLeftSidebar.vue */ "./resources/js/src/views/apps/todo/TodoLeftSidebar.vue");
/* harmony import */ var _todoStoreModule__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./todoStoreModule */ "./resources/js/src/views/apps/todo/todoStoreModule.js");
/* harmony import */ var _TodoTaskHandlerSidebar_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./TodoTaskHandlerSidebar.vue */ "./resources/js/src/views/apps/todo/TodoTaskHandlerSidebar.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    // App SFC
    TodoLeftSidebar: _TodoLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    TodoTaskHandlerSidebar: _TodoTaskHandlerSidebar_vue__WEBPACK_IMPORTED_MODULE_17__["default"]
  },
  setup: function setup() {
    var TODO_APP_STORE_MODULE_NAME = 'app-todo'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_7__["default"].hasModule(TODO_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_7__["default"].registerModule(TODO_APP_STORE_MODULE_NAME, _todoStoreModule__WEBPACK_IMPORTED_MODULE_16__["default"]); // UnRegister on leave

    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_7__["default"].hasModule(TODO_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_7__["default"].unregisterModule(TODO_APP_STORE_MODULE_NAME);
    });

    var _useRouter = Object(_core_utils_utils__WEBPACK_IMPORTED_MODULE_13__["useRouter"])(),
        route = _useRouter.route,
        router = _useRouter.router;

    var routeSortBy = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["computed"])(function () {
      return route.value.query.sort;
    });
    var routeQuery = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["computed"])(function () {
      return route.value.query.q;
    });
    var routeParams = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["computed"])(function () {
      return route.value.params;
    });
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])(routeParams, function () {
      // eslint-disable-next-line no-use-before-define
      fetchTasks();
    });
    var tasks = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])([]);
    var sortOptions = ['latest', 'title-asc', 'title-desc', 'assignee', 'due-date'];
    var sortBy = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(routeSortBy.value);
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])(routeSortBy, function (val) {
    ...
    var task = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(JSON.parse(JSON.stringify(blankTask)));
    ...
    var addTask = function addTask(val) {
      _store__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch('app-todo/addTask', val).then(function () {
        // eslint-disable-next-line no-use-before-define
        fetchTasks();
      });
    };
    ...
    var removeTask = function removeTask() {
      _store__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch('app-todo/removeTask', {
        id: task.value.id
      }).then(function () {
        // eslint-disable-next-line no-use-before-define
        fetchTasks();
    ...
    var updateTask = function updateTask(taskData) {
      _store__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch('app-todo/updateTask', {
        task: taskData
      }).then(function () {
        // eslint-disable-next-line no-use-before-define
        fetchTasks();
    ...
    var isTaskHandlerSidebarActive = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(false);
    var taskTags = [{
      title: 'Team',
      color: 'primary',
      route: {
    ...
    var searchQuery = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(routeQuery.value);
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])(routeQuery, function (val) {
      searchQuery.value = val;
    }); // eslint-disable-next-line no-use-before-define

    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])([searchQuery, sortBy], function () {
      return fetchTasks();
    });
    ...
    var fetchTasks = function fetchTasks() {
      _store__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch('app-todo/fetchTasks', {
        q: searchQuery.value,
    ...
    var _useResponsiveAppLeft = Object(_core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_14__["useResponsiveAppLeftSidebarVisibility"])(),
    ...
    return {
      ...
      // Filters
      formatDate: _core_utils_filter__WEBPACK_IMPORTED_MODULE_12__["formatDate"],
      avatarText: _core_utils_filter__WEBPACK_IMPORTED_MODULE_12__["avatarText"],
      // Single Task isCompleted update
...
function useTaskHandler(props, emit) {
  ...
  // taskLocal
  // ------------------------------------------------
  var taskLocal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__["ref"])(JSON.parse(JSON.stringify(props.task.value)));

  var resetTaskLocal = function resetTaskLocal() {
    taskLocal.value = JSON.parse(JSON.stringify(props.task.value));
  };

  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__["watch"])(props.task, function () {
    resetTaskLocal();
  }); // ------------------------------------------------
