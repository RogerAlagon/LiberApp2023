...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************/
...
/* harmony import */ var cleave_js_dist_addons_cleave_phone_us__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! cleave.js/dist/addons/cleave-phone.us */ "./node_modules/cleave.js/dist/addons/cleave-phone.us.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    Guardar: function Guardar() {
      ...
      this.$http.post('/LiberAPP/Persona/Guardar', {
        ...
        _this.Toast(true, 'success', 'Crear Papeleta', 'Guardado Correctamente');
        ...
        _this.Toast(true, 'danger', 'Crear Papeleta', 'Error al guardar el registro: ' + error);
    ...
    Actualizar: function Actualizar() {
      ...
      this.$http.post('/LiberAPP/Persona/Actualizar', {
        ...
        _this2.Toast(true, 'primary', 'Actualizar Papeleta', 'Actualizado Correctamente');
        ...
        _this2.Toast(true, 'danger', 'Actualizar Papeleta', 'Error al actualizar el registro: ' + error);

        _this2.showLoading = false;
      });
    },
    DiferenciaFecha: function DiferenciaFecha() {
      if (this.papeleta.finicioPer == this.papeleta.ffinPer) {
        this.Motivos('hora');
        this.estadoHora = false;
    ...
    DiferenciaHora: function DiferenciaHora(inicio, fin) {
      inicio = inicio.split(":");
      fin = fin.split(":");
    ...
    Motivos: function Motivos(estado) {
      var _this3 = this;

      this.$http.get('/LiberAPP/Persona/Motivo/' + estado).then(function (res) {
        _this3.motivos = res.data;
      })["catch"](function (error) {
        _this3.Toast(true, 'danger', 'Motivo', 'Error al cargar los registros: ' + error);
      });
    },
    Papeleta: function Papeleta() {
      var _this4 = this;

      this.$http.get('/LiberAPP/Persona/Papeleta/' + this.userData.id + '/solicitud').then(function (res) {
        _this4.papeletas = res.data;
      })["catch"](function (error) {
        _this4.Toast(true, 'danger', 'Papeletas', 'Error al cargar los registros: ' + error);
      });
    },
    PapeletaBaja: function PapeletaBaja(prm_papeleta) {
      var _this5 = this;
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          _this5.papeleta.estadoPer = 'ANULADO';
          var jsonPapeleta = JSON.stringify(_this5.papeleta);

          _this5.$http.post('/LiberAPP/Persona/Anular', {
            permiso: jsonPapeleta
          }).then(function (res) {
            _this5.$swal({
              icon: 'success',
            ...
            _this5.Toast(true, 'danger', 'Anular Papeleta', 'Error al anular papeleta: ' + error);
          });
        }
      });
    }
  ...
  created: function created() {
    ...
    this.$http.get('/LiberAPP/Persona/Motivo/todo').then(function (res) {
      _this6.motivos = res.data;
    })["catch"](function (error) {
      _this6.Toast(true, 'danger', 'Motivo', 'Error al cargar los registros: ' + error);
    });
    this.$http.get('/LiberAPP/Persona/Papeleta/' + this.userData.id + '/solicitud').then(function (res) {
      _this6.papeletas = res.data;
      console.log('Responsable:: ', res.data);
    })["catch"](function (error) {
      _this6.Toast(true, 'danger', 'Papeletas', 'Error al cargar los registros: ' + error);
    });
  }
});
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=style&index=0&lang=scss&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./node_modules/sass-loader/dist/cjs.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
var ___CSS_LOADER_AT_RULE_IMPORT_1___ = __webpack_require__(/*! -!../../../../../../node_modules/css-loader/dist/cjs.js!sweetalert2/dist/sweetalert2.min.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sweetalert2/dist/sweetalert2.min.css");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce& ***!
  \**********************************************************************************************************************************************************************************************************************************/
                ...
                fn: function(props) {
                  return [
                    props.column.field == "acciones"
                              ...
                              "b-button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.PapeletaBaja(props.formattedRow)
                                  }
                                }
                              },
                              [
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    props.column.field === "jefeareaPer"
                      ? _c(
                          "span",
                          [
                            props.row.jefeareaPer == null
                              ? _c("b-badge", [_vm._v("SIN ACCION")])
                              : _vm._e(),
                            _vm._v(" "),
                            props.row.jefeareaPer == "0" ||
                            props.row.jefeareaPer == "true"
                              ? _c(
                                  "b-badge",
                                  { attrs: { variant: "success" } },
                                  [_vm._v("APROBADO")]
                              ...
                              : _vm._e(),
                            _vm._v(" "),
                            props.row.jefeareaPer == "1" ||
                            props.row.jefeareaPer == "false"
                              ? _c(
                                  "b-badge",
                      ...
                      : props.column.field === "recursoPer"
                      ? _c(
                          "span",
                          [
                            props.row.recursoPer == null
                              ? _c("b-badge", [_vm._v("SIN ACCION")])
                              : _vm._e(),
                            _vm._v(" "),
                            props.row.recursoPer == "0" ||
                            props.row.recursoPer == "true"
                              ? _c(
                                  "b-badge",
                                  { attrs: { variant: "success" } },
                                  [_vm._v("APROBADO")]
                              ...
                              : _vm._e(),
                            _vm._v(" "),
                            props.row.recursoPer == "1" ||
                            props.row.recursoPer == "false"
                              ? _c(
                                  "b-badge",
                                  { attrs: { variant: "danger" } },
                                  [_vm._v("ANULADO")]
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("b-form-input", {
                            attrs: { readonly: "" },
                            model: {
                              value: _vm.papeleta.idPermiso,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "idPermiso", $$v)
                              },
                              expression: "papeleta.idPermiso"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("flat-pickr", {
                            ...
                            attrs: { disabled: "" },
                            model: {
                              value: _vm.papeleta.fechaPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "fechaPer", $$v)
                              },
                              expression: "papeleta.fechaPer"
                            }
                          })
                        ],
                        1
                          ...
                          _c("flat-pickr", {
                            ...
                            on: {
                              input: function($event) {
                                return _vm.DiferenciaFecha()
                              }
                            },
                            model: {
                              value: _vm.papeleta.finicioPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "finicioPer", $$v)
                              },
                              expression: "papeleta.finicioPer"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("flat-pickr", {
                            staticClass: "form-control",
                            attrs: {
                              config: { minDate: _vm.papeleta.finicioPer }
                            },
                            on: {
                              input: function($event) {
                                return _vm.DiferenciaFecha()
                            ...
                            model: {
                              value: _vm.papeleta.ffinPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "ffinPer", $$v)
                              },
                              expression: "papeleta.ffinPer"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("v-select", {
                            ...
                            attrs: {
                              label: "valorDat",
                              reduce: function(motivos) {
                                return motivos.idDato
                              },
                              options: _vm.motivos
                            },
                            model: {
                              value: _vm.papeleta.Permiso_idDato,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "Permiso_idDato", $$v)
                              },
                              expression: "papeleta.Permiso_idDato"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("flat-pickr", {
                            ...
                            model: {
                              value: _vm.papeleta.hinicioPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "hinicioPer", $$v)
                              },
                              expression: "papeleta.hinicioPer"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("flat-pickr", {
                            ...
                            model: {
                              value: _vm.papeleta.hfinPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "hfinPer", $$v)
                              },
                              expression: "papeleta.hfinPer"
                            }
                          })
                        ],
                        1
            ...
            [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("b-form-textarea", {
                            ...
                            model: {
                              value: _vm.papeleta.destinoPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "destinoPer", $$v)
                              },
                              expression: "papeleta.destinoPer"
                            }
                          })
                        ],
                        1
              ...
              _c(
                ...
                [
                  _c(
                    "b-form-group",
                    { attrs: { label: "Observación / sustento" } },
                    [
                      _c(
                        "b-input-group",
                        { staticClass: "input-group-merge" },
                        [
                          ...
                          _c("b-form-textarea", {
                            ...
                            model: {
                              value: _vm.papeleta.observacionPer,
                              callback: function($$v) {
                                _vm.$set(_vm.papeleta, "observacionPer", $$v)
                              },
                              expression: "papeleta.observacionPer"
                            }
                          })
                        ],
                        1
...
/***/ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue":
/*!*********************************************************************!*\
  !*** ./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Solicitud.vue?vue&type=template&id=2ee494ce& */ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce&");
/* harmony import */ var _Solicitud_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Solicitud.vue?vue&type=script&lang=js& */ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _Solicitud_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Solicitud.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=style&index=0&lang=scss&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/Asistencia/Transaccion/Solicitud.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=style&index=0&lang=scss&":
/*!*******************************************************************************************************!*\
  !*** ./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce&":
/*!****************************************************************************************************!*\
  !*** ./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce& ***!
  \****************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Solicitud.vue?vue&type=template&id=2ee494ce& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Asistencia/Transaccion/Solicitud.vue?vue&type=template&id=2ee494ce&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Solicitud_vue_vue_type_template_id_2ee494ce___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
