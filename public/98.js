...
module.exports = "/images/_/_/_/_/produccion/resources/js/src/assets/images/pages/calendar-illustration.png";
...
function userCalendar() {
  ...
  var refCalendar = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(null); // ------------------------------------------------
  // calendarApi
  // ------------------------------------------------
  ...
  var event = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(JSON.parse(JSON.stringify(blankEvent)));
  ...
  var addEvent = function addEvent(eventData) {
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch('calendar/addEvent', {
      event: eventData
    }).then(function () {
  ...
  var updateEvent = function updateEvent(eventData) {
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch('calendar/updateEvent', {
      event: eventData
    }).then(function (response) {
  ...
  var removeEvent = function removeEvent() {
    ...
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch('calendar/removeEvent', {
      id: eventId
    }).then(function () {
  ...
  var selectedCalendars = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["computed"])(function () {
    return _store__WEBPACK_IMPORTED_MODULE_9__["default"].state.calendar.selectedCalendars;
  });
  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])(selectedCalendars, function () {
    refetchEvents();
  }); // --------------------------------------------------------------------------------------------------
  // AXIOS: fetchEvents
  ...
  var fetchEvents = function fetchEvents(info, successCallback) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch('calendar/fetchEvents', {
  ...
  var calendarOptions = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])({
    plugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_5__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_list__WEBPACK_IMPORTED_MODULE_4__["default"]],
    ...
    */
    ...
    direction: Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["computed"])(function () {
      return _store__WEBPACK_IMPORTED_MODULE_9__["default"].state.appConfig.isRTL ? 'rtl' : 'ltr';
    }),
    rerenderDelay: 350
  }); // ------------------------------------------------------------------------
  // *===============================================---*
  ...
  var isEventHandlerSidebarActive = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(false);
  var isCalendarOverlaySidebarActive = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(false);
  return {
    refCalendar: refCalendar,
    isCalendarOverlaySidebarActive: isCalendarOverlaySidebarActive,
    calendarOptions: calendarOptions,
